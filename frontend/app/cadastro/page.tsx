        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <RadioGroup
                value={userType}
                onValueChange={(value) => setUserType(value as "fisica" | "juridica")}
            ...
            <div className="space-y-2">
              <Label htmlFor="name">Nome {userType === "juridica" ? "da Empresa" : "Completo"}</Label>
              <Input
                id="name"
                type="text"
                value={formData.name}
            ...
            <div className="space-y-2">
              <Label htmlFor="document">{userType === "fisica" ? "CPF" : "CNPJ"}</Label>
              <Input
                id="document"
                type="text"
